...
function mobileVersion() {
    ...
    slideOne.classList.remove("my_background");

    var slideTwo = document.getElementById("slide-two");
    slideTwo.classList.remove("my_background");
    $('.navigation_down').css({
        'display': 'block',
    });
}
...
function webVersion() {
    ...
    // var slideOne = document.getElementById("slide-one");
    // slideOne.classList.add("my_background");

    // var slideTwo = document.getElementById("slide-two");
    // slideTwo.classList.add("my_background");
}
